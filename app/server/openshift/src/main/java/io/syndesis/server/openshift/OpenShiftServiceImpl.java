        ...
        openShiftClient.deploymentConfigs().withName(name).createOrReplaceWithNew()
            ...
            .withNewSpec()
                ...
                .withNewTemplate()
                    ...
                    .withNewSpec()
                        .addNewContainer()
                        .withImage("172.30.1.1:5000/syndesis/syndesis-integration-image:latest")
                        .withName(name)
                        ...
                        .withEnv(
                            ...
                            new EnvVar("JAVA_OPTIONS", "-Dthin.offline=true -Dthin.root=/.m2", null))
                        .addNewPort()
                            .withName("jolokia")
